...
module.exports = (sequelize, DataTypes) => {
    var Model = sequelize.define('User', {
        ...
        phone     : {type: DataTypes.STRING, allowNull: true, unique: true, validate: { len: {args: [7, 12], msg: "Phone number invalid, too short or long."}, isNumeric: { msg: "enter only digits"} }},
